...
const Item = ({
  ...
  <TouchableOpacity onPress={() => onClick()} style={styles.category_inner}>
...
const Top = ({ navigation }: { navigation: any }) => {
  const renderItem = ({
    item,
  }: {
    item: {
  ...
  return (
    <View>
      ...
      <TouchableOpacity
        ...
        style={styles.map__button}
      >
        <Text style={styles.hero__buttonText}>地図を見る</Text>
      </TouchableOpacity>
